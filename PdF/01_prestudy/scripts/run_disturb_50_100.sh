...
#SBATCH -J mallob-disturbance-50-100

# ATTENTION: this benchmark should be performed on partition "diffie" or "hellman"

# configuration
dir="./PdF/01_prestudy"
results_dir="${dir}/results/${SLURM_JOB_ID}_results_disdurb_50_100"
...
`# templates for the 1/2 client(s)` -client-template=${dir}/templates/client-template-disturbed-50-100.json \
