...
#SBATCH -J mallob-disturbance-62_5

# ATTENTION: this benchmark should be performed on partition "diffie" or "hellman"

# configuration
dir="./PdF/01_prestudy"
results_dir="${dir}/results/${SLURM_JOB_ID}_results_undisdurb_62_5"
...
# command
cmd="
`# run mallob with 1 client (undisturbed)` build/mallob -c=1 \
`# templates for the 1/2 client(s)` -client-template=${dir}/templates/client-template-undisturbed.json \
